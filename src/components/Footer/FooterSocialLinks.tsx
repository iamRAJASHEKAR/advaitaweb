...
type SocialId = "linkedin" | "facebook" | "instagram" | "youtube";
...
export function FooterSocialLinks() {
  return (
    <div className="site-footer__social-wrap">
      <p className="site-footer__social-label">{strings.footer.socialHeading}</p>
      <ul className="site-footer__social" aria-label="Social media">
        {strings.footer.social.map((item) => (
          <li key={item.id}>
            <a
              href={item.href}
            ...
            >
              <SocialIcon id={item.id as SocialId} />
            </a>
          </li>
        ))}
      </ul>
